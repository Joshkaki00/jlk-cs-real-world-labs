# Module 8.5: Debugging as a Distinct Skill (Not a Side Effect of Coding Skill)

_Companion lab for "Module 8.5: Debugging as a Distinct Skill (Not a Side Effect of Coding Skill)" in the curriculum (private repo, not linked here)._
