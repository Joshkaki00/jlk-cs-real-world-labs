# Module 18.6: Advocating for Your Own Value

_Companion lab for "Module 18.6: Advocating for Your Own Value" in the curriculum (private repo, not linked here)._
