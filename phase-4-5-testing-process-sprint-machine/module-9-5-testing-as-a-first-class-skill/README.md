# Module 9.5: Testing as a First-Class Skill

_Companion lab for "Module 9.5: Testing as a First-Class Skill" in the curriculum (private repo, not linked here)._
