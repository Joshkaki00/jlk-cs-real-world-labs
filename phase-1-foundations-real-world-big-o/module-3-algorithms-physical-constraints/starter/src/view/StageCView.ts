...
// TODO(starter): each `+=` on a string copies everything built so far —
// 1 copy, then 2, then 3 ... up to N copies. What does that triangular sum
// actually grow like? Fix this constant to the correct choice above.
const CORRECT_ANSWER: AnswerC = 'n';
