# Module 11.5: Writing It Down  -  Technical Writing as a Core Skill

_Companion lab for "Module 11.5: Writing It Down  -  Technical Writing as a Core Skill" in the curriculum (private repo, not linked here)._
